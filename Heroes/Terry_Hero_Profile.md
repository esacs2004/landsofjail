...
Source: images/Terry/ screenshots provided in this workspace
...
|---|---|---|
| Buster Wolf | Charges at enemies, dealing AoE DMG equal to ATK*360% and stunning for 1.5 seconds. | Static (no progression). |
| Power Dunk | Leaps towards an enemy, dealing DMG equal to ATK*280% and stunning the target for 1.5 seconds. | Static (no progression). |
| Power Wave | Increases ATK by 50% when HP is above 50%. | Static (no progression). |

### War skills
| Skill | Base effect shown | Level progression shown |
|---|---|---|
| Solid Defense | Increases all allied troops' DEF by 20%. | Troops DEF: 5% / 10% / 15% / 20% / 25% |
...
| Minion HP | 960 |
| Bomber HP | +15.75% |
| Bomber Lethality | +15.75% |

### Equipment max/preview snapshot shown (Lv.10)
- Power shown: 518,520
...
- Burning Knuckle effect at Lv.2 and Lv.5.
- Fuel Stockpile effect at Lv.1 and Lv.5.

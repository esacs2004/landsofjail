# Tyronn, Scarlet Butcher

Last updated: 2026-06-25
Source: images/Tyronn/ screenshots provided in this workspace

## 1) Hero Overview (Pre-Claim State)
- Hero name: Tyronn
...
### Arrest (Max Level and Star Stats panel)
| Stat | Value |
|---|---:|
| Hero ATK | 5,108 |
| Hero DEF | 6,660 |
...
### War (Max Level and Star Stats panel)
| Stat | Value |
|---|---:|
...
- Multiple skills show unlock requirements tied to star level.

### Arrest-side skills visible
| Skill | Base effect shown | Level progression shown | Unlock note shown |
|---|---|---|---|
| Wrathful Roar | Deals AoE DMG equal to 390% of ATK and stuns the targets for 1.5s. | AoE DMG Increase: 390% / 438% / 486% / 534% / 582% | Not shown on this panel |
| Mighty Smash | Slams the ground, dealing DMG equal to 160% ATK to all enemies within range. | AoE DMG Increase: 160% / 175% / 190% / 205% / 220% | Unlock Requires: 1-Star Hero |
| Massacre | Increases DMG dealt by 12%. | DMG Dealt Increase: 12% / 17% / 22% / 27% / 32% | Unlock Requires: 2-Star Hero |

### War-side skills visible
| Skill | Base effect shown | Level progression shown | Unlock note shown |
|---|---|---|---|
| Cripple | Increases all enemy troops' DMG taken by 5%. | Increased DMG to Enemies: 5% / 10% / 15% / 20% / 25% | Not shown on this panel |
...
- Max-level/max-star reference stat panel values that are visible.
- Names/effects/progressions for six visible skills in locked-state panels.
- Bloodlust max-star bonus tooltip.

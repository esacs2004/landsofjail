...
Source: images/Mai/ screenshots provided in this workspace
...
|---|---|---|
| Hissatsu Shinobi-Bachi | Charges toward the target, dealing DMG equal to ATK*480% to enemy units in the path. | Static (no progression). |
| Ryuuenbu | Charges towards the target, dealing AoE DMG equal to ATK*420%. | Static (no progression). |
| Musasabi no Mai | Increases ATK Speed by 25% every 3 attacks. | Static (no progression). |

### War/development skills
| Slot state | Level shown | Notes |
|---|---|---|
| War slot 1 icon visible | Lv.3 | Name/effect text not visible in screenshots. |
| War slot 2 icon visible | Lv.3 | Name/effect text not visible in screenshots. |
| War slot 3 icon visible | Lv.4 | Name/effect text not visible in screenshots. |
...
| Stat group | Value shown |
|---|---|
| Hero ATK / DEF / HP | Unavailable while not activated |
| Minion ATK / DEF / HP | Unavailable while not activated |
| Shooter HP / Lethality | Unavailable while not activated |

### Exclusive equipment skills shown
| Skill | Category | Level shown | Effect shown |
|---|---|---|---|
| Hishou Ryuuenjin | Arrest | Lv.0 | Increases all allied Heroes' ATK by 0% (8%). |
...
- Sync bonus popups for Art of Shiranui and Fighting Spirit Accumulation.
- Arrest skills are static for Mai (user-confirmed gameplay behavior).
